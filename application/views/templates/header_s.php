                    ...
                    <div class="scrollbar-sidebar scrollbar-container">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="">
                                    <a href="<?php echo site_url('DashboardSupervisor')?>">
                                ...
                                <li>
                                    <a href="<?php echo site_url('LokasiSupervisor')?>">
                                ...
                                <li>
                                    <a href="<?php echo site_url('JobDescSupervisor')?>">
                                        <i class="metismenu-icon fa fa-group"></i>
                                        Job Desc Petugas
                                    </a>
                                ...
                                <li>
                                    <a href="<?php echo site_url('LaporanSupervisor')?>">
                    ...
                    <div class="app-header">
                        <div class="page-title-heading">
                            ...
                            <div class="page-title-subheading">
                                Selamat Datang di Halaman Supervisor
                            </div>
                        </div>
